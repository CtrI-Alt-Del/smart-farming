...
class GetSensorsRecordsTablePageData:
    def execute(self, page_number: int = 1, should_get_plants: bool = False) -> tuple[list[SensorsRecord], int, list[Plant]]:
        ...
        pages_count = ceil(sensors_records_count / PAGINATION_LIMIT)
